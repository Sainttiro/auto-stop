...
### 🔧 Исправлено
- Workflow теперь срабатывает при push тега

## [1.0.1] - 2025-10-20

### ✨ Добавлено
- Поддержка Tailscale для безопасного доступа к домашнему серверу
- Санитизация IP адресов в документации

### 📚 Документация
- Добавлены руководства по настройке Tailscale
...
- Автоматическое выставление SL/TP после исполнения сделок
...
- Автоматическое переподключение при разрывах соединения (100 попыток)
...
- [Репозиторий](https://github.com/Sainttiro/auto-stop)
- [Документация](docs/)
- [Критические исправления](docs/CRITICAL_FIXES.md)
