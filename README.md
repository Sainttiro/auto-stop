...
[![Version](https://img.shields.io/badge/version-v2.6.0-blue.svg)](https://github.com/Sainttiro/auto-stop/releases/tag/v2.6.0)
...
**Текущая версия:** v2.6.0 (31.10.2025)
...
- Автоматическая проверка кода при каждом PR и push
- Строгие проверки перед деплоем в production
- Автоматическая сборка и публикация Docker образа
- Автоматический деплой на сервер

Подробнее: [docs/GITHUB_SETUP.md](docs/GITHUB_SETUP.md)
